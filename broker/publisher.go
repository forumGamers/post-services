...
func (ch *PublisherImpl) DeclareExchangeAndQueue() {
	...
	queues := []string{NEWPOSTQUEUE, DELETEPOSTQUEUE, BULKPOSTQUEUE, NEWLIKEQUEUE, DELETELIKEQUEUE, NEWCOMMENTQUEUE, DELETECOMMENTQUEUE, NEWREPLYQUEUE, DELETEREPLYQUEUE, NEWSHAREQUEUE, DELETESHAREQUEUE}
